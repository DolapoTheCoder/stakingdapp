...
function App() {
  ...
  const calcDaysRemaining = (unlocedkDate) => {
    const timeNow = Date.now() / 1000
    const secondsRemaining = unlocedkDate - timeNow
  ...
  const connectAndLoad = async () => {
    ...
    //if not assets then nothing will be loaded
  }
...
//   const getSigner = async () => {
//     await provider.send("eth_requestAaccounts", [])
      ...
      <div className="appBody">
        <div className="marketContainer">
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <div onClick={() => openStakingModel(90, '10%')} className="marketOption">
                <div className="glyphContainer hoverButton">
                  <span className="glyph">
                    <Coin />
                  </span>
            ...
            <div className="col-md-4">
              <div onClick={() => openStakingModel(180, '12%')} className="marketOption">
                <div className="glyphContainer hoverButton">
                  <span className="glyph">
                    <Coin />
                  </span>
